...
KAFFEEKASSE = {
    ...
    # Number of days in the past that are used as time intervall limit to
    # search for 'Häufig gekauft'
    'T_MOST_BOUGHT_PRODUCTS_D': 30,
    # Number of charges that should be shown in 'Letzte Aufladungen'. A
    # negative number means 'all users are selected'
    'N_LAST_CHARGES': 10,
