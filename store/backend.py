...
class PurchaseLogic:
    ...
    def purchase(user_id, product_identifier, product_identifier_type, token):
        ...
        *)  Product: update the product stock
        Possible Exceptions: NegativeMoneyAmount, UserIdentifierNotExists, UserNotEnoughMoney
    ...
    def annullatePurchase(purchase_id, token):
        ...
        long ago.
        Possible Exceptions: PurchaseNotAnnullable, NegativeMoneyAmount
...
class ChargeLogic:
    ...
    def charge(user_id, amount, token):
        ...
        *)  Charge, where the new charge is saved to
        Possible Exceptions: NegativeMoneyAmount
    ...
    def annullateCharge(charge_id, token):
        ...
        Possible Exceptions: ChargeNotAnnullable, NegativeMoneyAmount, UserNotEnoughMoney
...
class TransferLogic:
    ...
    def transfer(user_id, receiver_identifier, receiver_identifier_type, amount, token):
        ...
        *)  Transfer, where the newly created transfer is saved to
        Possible Exceptions: UserNotEnoughMoney, NegativeMoneyAmount, UserIdentifierNotExists
    ...
    def annullateTransfer(transfer_id, token):
        ...
        Possible Exceptions: TransferNotAnnullable, UserNotEnoughMoney, NegativeMoneyAmount
