...
class ProductLogic:
    ...
    def getProduct(identifier, identifier_type):
        ...
        Possible Exceptions: ProductIdentifierNotExists
        :param identifier: on of the user identifiers
        :param identifier_type: type of the identifier
        """
...
class TokenLogic:
    ...
    def get_token():
        ...
        Possible Exceptions: SerializationError
...
class PurchaseLogic:
    ...
    def purchase(user_id, product_identifier, product_identifier_type, token):
        ...
        *)  Product: update the product stock
        Possible Exceptions: NegativeMoneyAmount, UserIdentifierNotExists, UserNotEnoughMoney, SerializationError
    ...
    def annullatePurchase(purchase_id, token):
        ...
        long ago.
        Possible Exceptions: PurchaseNotAnnullable, NegativeMoneyAmount, SerializationError
...
class ChargeLogic:
    ...
    def charge(user_id, amount, token):
        ...
        *)  Charge, where the new charge is saved to
        Possible Exceptions: NegativeMoneyAmount, SerializationError
    ...
    def annullateCharge(charge_id, token):
        ...
        Possible Exceptions: ChargeNotAnnullable, NegativeMoneyAmount, UserNotEnoughMoney, SerializationError
...
class TransferLogic:
    ...
    def annullateTransfer(transfer_id, token):
        ...
        Possible Exceptions: TransferNotAnnullable, UserNotEnoughMoney, NegativeMoneyAmount, SerializationError
